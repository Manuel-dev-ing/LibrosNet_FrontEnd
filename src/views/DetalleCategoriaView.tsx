...
import { getBooksByCategory, getCategories } from '../services/CategoriaAPI'
import type { Libros } from '../types'
import CardProduct from '../components/CardProduct'

export default function DetalleCategoriaView() {
  ...
  const {data, isLoading} = useQuery({
      queryFn: () => getBooksByCategory(CategoriaId),
      queryKey: ["categoriasLibros", CategoriaId],
