...
export default function AddBookForm({preview, errors, register, autores, categorias, editoriales} : AddBookFormProps) {
  return (
                ...
                <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <div>
                        ...
                        <input type='file' className="form-control" id="portada" accept="image/*" 
                            ...
                            {...(preview === "" && register("portada", {
                                required: "La Portada del libro es obligatoria",
                            }))} 
                        />
                            {errors && (
                                <ErrorMessage>{errors.portada?.message}</ErrorMessage>
                            )}
